...
La función `interpolar_perfiles()` permite transformar el perfil en horizontes estandarizados utilizando (por ahora) promedios ponderados. El argumento `variables` recibe un vector con las variables a estandarizar y por defecto genera horizontes cada 30 centrímetros. 
